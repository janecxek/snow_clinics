...
(function () {
  ...
  var DE = {
    ...
    'nav.concerns': 'Anliegen',
    'cta.ask': 'Dazu fragen <span aria-hidden="true">→</span>',
    'chips.label': 'Behandelt',
    'concerns.eyebrow': 'Weshalb Menschen kommen',
    'concerns.h': 'Sagen Sie, was Sie stört. Den Rest übernehmen wir.',
    'concerns.lede': 'Sechs Anliegen, nach denen am häufigsten gefragt wird. Wählen Sie das, was auf Sie zutrifft — wir zeigen Ihnen, was dazu passt.',
    'cn.see': 'Passende Behandlungen',
    'cn.1.t': 'Linien, die bleiben, wenn die Mimik geht',
    'cn.1.d': 'Stirn und äusseres Auge behalten die Falte, auch wenn das Gesicht entspannt ist.',
    'cn.2.t': 'Eine Braue, die schwer geworden ist',
    'cn.2.d': 'Die Augen wirken auf Fotos müde — selbst an einem Morgen, an dem Sie ausgeruht sind.',
    'cn.3.t': 'Lippen, die ihre Kontur verloren haben',
    'cn.3.d': 'Nicht unbedingt kleiner, eher weniger definiert — und der Lippenstift bleibt nicht mehr an Ort.',
    'cn.4.t': 'Eine Kieferlinie, die weicher geworden ist',
    'cn.4.d': 'Die Linie von früher ist noch da. Sie ist nur nach unten gewandert.',
    'cn.5.t': 'Haut, die auf Fotos flach wirkt',
    'cn.5.d': 'Textur, Fahlheit oder Pigment, die Make-up überdeckt statt korrigiert.',
    'cn.6.t': 'Dünner werdendes Haar am Scheitel',
    'cn.6.d': 'Mehr sichtbare Kopfhaut als vor einem Jahr — und mehr Haar in der Bürste.',
    'p.botox.c1': 'Stirn',
    'p.botox.c2': 'Zornesfalte',
    'p.botox.c3': 'Krähenfüsse',
    'p.botox.c4': 'Brauenlift',
    'p.men.c1': 'Kieferlinie',
    'p.men.c2': 'Müde Augen',
    'p.men.c3': 'Schwere Braue',
    'p.lips.c1': 'Kontur',
    'p.lips.c2': 'Volumen',
    'p.lips.c3': 'Feuchtigkeit',
    'p.lips.c4': 'Lippenfältchen',
    'p.threads.c1': 'Mittelgesicht',
    'p.threads.c2': 'Kieferlinie',
    'p.threads.c3': 'Hals',
    'p.threads.c4': 'Braue',
    'p.meso.c1': 'Gesicht',
    'p.meso.c2': 'Hals',
    'p.meso.c3': 'Dekolleté',
    'p.meso.c4': 'Hände',
    'p.boosters.c1': 'Feine Linien',
    'p.boosters.c2': 'Fahlheit',
    'p.boosters.c3': 'Elastizität',
    'p.boosters.c4': 'Augenringe',
    'p.cleansing.c1': 'Unreinheiten',
    'p.cleansing.c2': 'Mitesser',
    'p.cleansing.c3': 'Textur',
    'p.body.c1': 'Bauch',
    'p.body.c2': 'Flanken',
    'p.body.c3': 'Oberschenkel',
    'p.body.c4': 'Arme',
    'p.hair.c1': 'Dichte',
    'p.hair.c2': 'Kopfhaut',
    'p.hair.c3': 'Haarausfall nach Geburt',
    'pledge.1': 'Kliniken in drei Ländern — alle nach demselben Standard, von derselben Ärztin geführt.',
    'pledge.2n': '2 Wochen',
    'pledge.2': 'Jedes Resultat wird kontrolliert, bevor es als fertig gilt. Der Termin ist inbegriffen.',
    'pledge.3n': '48 Stunden',
    'pledge.3': 'Vorlauf genügt, um kostenfrei zu verschieben oder abzusagen — ohne Begründung.',
    'reviews.h': 'Von Patientinnen, die mit Ihrer Frage kamen.',
    'reviews.lede': 'Mit Einverständnis bei der Kontrolle nach zwei Wochen erhoben.',
    'meta.treat': 'Behandlung',
    'meta.clinic': 'Standort',
    'meta.since': 'Patientin seit',
    'q1.m1': 'Skinbooster',
    'q2.m1': 'Botulinumtoxin',
    'q3.m1': 'Lippenkonturierung',
    'q4.m1': 'Protokoll für Männer',
    'faq.eyebrow': 'Klare Antworten',
    'faq.h': 'Was gefragt wird, sobald die Tür zu ist.',
    'faq.lede': 'Dr. Snow beantwortet diese Fragen selbst. Fehlt Ihre, stellen Sie sie im Formular unten.',
    ...
    'faq.a1': 'Die meisten beschreiben Injektionen als unangenehm, nicht als schmerzhaft. Oberflächenanästhesie wird standardmässig aufgetragen und zwanzig Minuten belassen, Filler enthalten Lidocain, Fadenlifting erfolgt in Lokalanästhesie. Sie dürfen jederzeit stoppen — das wird nie als Problem behandelt.',
    'faq.q2': 'Ich möchte am Ende nicht gemacht aussehen.',
    'faq.a2': 'Wir auch nicht — genau darauf ist diese Praxis ausgerichtet. Jeder Plan beginnt bewusst unterdosiert, wird nach zwei Wochen kontrolliert und nur dort ergänzt, wo das Resultat es verlangt. Würde Ihr Wunsch Ihre Züge verändern statt sie wiederherzustellen, sagt Dr. Snow das und schlägt etwas Kleineres vor — oder lehnt ab.',
    'faq.q3': 'Mit wie viel Ausfallzeit muss ich wirklich rechnen?',
    'faq.a3': 'Botulinumtoxin und Mesotherapie: nichts über eine Stunde Rötung hinaus. Lippen: zwei bis drei Tage Schwellung. Fäden: drei bis fünf Tage Druckempfindlichkeit und mögliche Blutergüsse. Welche Woche Sie freihalten sollten, erfahren Sie vor der Terminwahl — nicht danach.',
    'faq.q4': 'Warum nennen Sie mir am Telefon keinen Preis?',
    'faq.a4': 'Weil die ehrliche Antwort von Ihrer Anatomie abhängt und eine Zahl, bevor jemand Ihr Gesicht gesehen hat, geraten wäre. Nach der Beratung erhalten Sie einen schriftlichen Plan mit Reihenfolge, Intervallen und Gesamtkosten — und entscheiden in Ruhe, ohne dass etwas gebucht ist.',
    'faq.q5': 'Was, wenn ich nur eine Kleinigkeit möchte?',
    'faq.a5': 'Dann bekommen Sie genau das. Eine Beratung ist kein Verkaufsgespräch, und viele gehen mit einem Pflegeprotokoll und einem Termin in sechs Monaten statt mit einer Behandlung. Sie erhalten nie ein Angebot für etwas, wonach Sie nicht gefragt haben.',
    'faq.q6': 'Wie lange, bis ich das wieder machen muss?',
    'faq.a6': 'Botulinumtoxin hält drei bis vier Monate, Lippen sechs bis zwölf, Fäden zwölf bis achtzehn. Regenerative Behandlungen laufen als Kur und danach ein- bis zweimal jährlich als Auffrischung. Die Intervalle stehen im Plan, damit Sie die Jahreskosten vorher sehen — nicht hinterher.',
    'faq.q7': 'Was passiert beim ersten Termin tatsächlich?',
    'faq.a7': 'Fünfundvierzig Minuten Beratung. Anamnese, Gesichtsanalyse in Ruhe und in Bewegung, standardisierte Fotos und ein schriftlicher Plan. Am selben Tag wird nichts injiziert — Sie gehen mit Zeit zum Lesen und zum Umentscheiden.',
    'faq.q8': 'In welcher Sprache findet mein Termin statt?',
    'faq.a8': 'Deutsch, Englisch, Spanisch oder Polnisch — was Sie bei der Buchung angeben. Einwilligungen und Ihr schriftlicher Plan kommen in derselben Sprache.',
    'faq.q9': 'Kann ich kostenfrei verschieben oder absagen?',
    'faq.a9': 'Ja, mit 48 Stunden Vorlauf, und Sie müssen keinen Grund nennen. Die Kliniktage in Paris und Marbella sind begrenzt — früher abgesagt heisst nur, dass jemand anders den Platz bekommt.',
